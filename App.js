...
const RestrauntCard = (props) =>{
     ...
     return(<div className="card">
          <img src={"https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/"+restrautList[0].data.cloudinaryImageId}/>
          <h2>{restrautList[0].data.name}</h2>
          <h3>{restrautList[0].data.cuisines.join(", ")}</h3>
          <h4>{restrautList[0].data. lastMileTravelString} </h4>
     </div>
     )
}
const Body = () =>{
